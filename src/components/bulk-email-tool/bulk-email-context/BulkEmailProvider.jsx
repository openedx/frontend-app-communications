...
import scheduledEmailsTable, { scheduledEmailsTableInitialState } from '../bulk-email-task-manager/bulk-email-scheduled-emails-table/data/reducer';
...
export default function BulkEmailProvider({ children }) {
  ...
  const [state, dispatch] = useAsyncReducer(combineReducers({ editor, scheduledEmailsTable }), initialState);
